...
import 'package:chat_bot/SpeechRecordScreenSecond.dart';
...
class ChatbotSecond extends StatefulWidget {
  // const ChatbotSecond({super.key});
  ChatbotSecond(
      {super.key,
  ...
  static const String route = "/ChatbotSecond";
  int selectedIndex = 0;
  String? speechdata = '';
  String? replydata = '';
  String? languageName = '';
  ...
  @override
  State<ChatbotSecond> createState() => _ChatbotSecondState();
}

class _ChatbotSecondState extends State<ChatbotSecond>
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      if (widget.selectedIndex == 0) {
        ...
        Future.delayed(Duration(seconds: 1), () {
          messages.add(ChatMessage(
            message: 'Language detected: ${widget.languageName!}',
            path: "",
            isUser: false,
            time: '$time ${widget.languageName}',
            showButtons: GlobalLists.isButtonVisible.toString(),
  ...
  Future<void> uploadQuestionAudioFile(
   ...
   //       "https://chatbotapi.ortdemo.com/api/apiapp/question_speech_to_text_translate";
      ...
      if (response.statusCode == 200) {
        ...
        final String languageName = jsonResponse['detectedLanguageName'];
        ...
        if (GlobalLists.isButtonVisible == "true") {
          ...
          setState(() {
            setState(() {
              messages.add(ChatMessage(
                message: 'Language detected: ${languageName}',
                isUser: false,
                path:  '',
                time: '$time ${GlobalLists.languageDetected}',
                //1july
