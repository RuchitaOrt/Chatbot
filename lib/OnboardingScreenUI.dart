...
bool isAnimation=true;
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                       ...
                       isTablet(context) ?  SizedBox(height: 40):SizedBox(height: 0),
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                ...
                                color: Color(0xff2b3e2b),
                                  ...
                                  ConstrainedBox(
                            constraints: BoxConstraints(maxWidth: 600), // Limit max width for iPad
                            child: Wrap(
                              spacing: 12,
                              runSpacing: 12,
  ...
  children: [
    ...
    isSelected
        ...
        : const SizedBox(width: 18), // reserve space for check
  ],
),
                    ...
                    padding: EdgeInsets.symmetric(
                      vertical: isTablet(context) ? 14 : 3,
                      horizontal: isTablet(context) ? 22 : 12,
                    ),
                    onSelected: (selected) {
                      if (selected) {
                        setState(() {
                    ...
                    backgroundColor: const Color(0xffF0F0F0),
                            ...
                            child: ElevatedButton.icon(
                              ...
                              onPressed: () {
                                if (GlobalLists.languageDetected != null && GlobalLists.languageDetected!.isNotEmpty) {
